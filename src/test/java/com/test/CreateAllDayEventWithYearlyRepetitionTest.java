...
public class CreateAllDayEventWithYearlyRepetitionTest extends BaseClass {
	...
	public Object[][] getData0() throws IOException {
		...
		List<HashMap<String, String>> data = getJsonDataToMap(
				"C:\\Users\\DELL\\eclipse-workspace\\Lauditor2\\src\\test\\java\\file\\data\\Meetings\\AllDayWithYearlyRep.json");
