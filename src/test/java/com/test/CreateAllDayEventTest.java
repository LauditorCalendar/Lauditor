...
public class CreateAllDayEventTest extends BaseClass {
	...
	public void allFieldsEntered(HashMap<String, String> input) throws InterruptedException {
		...
		try {
			...
			viewMeetings.assertMeetingName1(input.get("EventName"));
			viewMeetings.assertMeetingAgenda1(input.get("assertmeetingAgenda"));
			viewMeetings.assertMeetingLink1(input.get("assertmeetingLink"));
			viewMeetings.assertPhoneNumber1(input.get("phoneNumber"));
			viewMeetings.assertTeamMember1(input.get("assertteamMember1"));
			viewMeetings.assertEntityandIndividual1(input.get("firmName"));
			viewMeetings.assertEntityandIndividual1(input.get("entityClient1"));
			viewMeetings.assertEntityandIndividual1(input.get("assertindividualMember1"));
	...
	public Object[][] getData0() throws IOException {
		...
		List<HashMap<String, String>> data = getJsonDataToMap(
				"C:\\Users\\DELL\\eclipse-workspace\\Lauditor2\\src\\test\\java\\file\\data\\Meetings\\createAllDayEvent.json");
