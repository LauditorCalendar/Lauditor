...
public class CreateGeneralMatterTest extends BaseClass {
	...
	public void clientsIndividuals(HashMap<String, String> input) throws InterruptedException {
		try {
			...
			createGeneralMatters.createGeneralMatter(input.get("caseTitle"), input.get("matterNumber"));
			// Select Groups
	...
	// Client Individuals with Team Members
	...
	// Client Individuals and Documents
	...
	// Client Individuals with TM and Documents
	...
	public void clientEntities(HashMap<String, String> input) throws InterruptedException {
		try {
			createGeneralMatters.createGeneralMatter(input.get("caseTitle"), input.get("matterNumber"));
			String[] groupNames = { input.get("groupName1"), input.get("groupName2") };
			createGeneralMatters.selecting(groupNames);
	...
	public void clientsIndividualsandTempClientsWithandDocuments(HashMap<String, String> input)
			throws InterruptedException {
		try {
			createGeneralMatters.createGeneralMatter(input.get("caseTitle"), input.get("matterNumber"));
			String[] groupNames = { input.get("groupName1"), input.get("groupName2") };
	...
	public Object[][] getData1() throws IOException {
		...
		List<HashMap<String, String>> data = getJsonDataToMap(
				"C:\\Users\\DELL\\eclipse-workspace\\Lauditor2\\src\\test\\java\\file\\data\\Matter\\CreateGeneralMatter.json");

		return new Object[][] { { data.get(0) } };

	}

	// MandatoryFieldswithGroupsandClientsIndividuals and Team Members
	@DataProvider
	...
	// Entity and Individual with Documents
	@DataProvider
	...
	// Entity and Individual with TM and Documents
	...
	// Mandatory with Temp clients and Team Members
	@DataProvider
	...
	// Mandatory with Temp clients and Documents
	@DataProvider
	...
	// Temp [Individual and Entity] and Permanent Individual with TM and Documents
	@DataProvider
	...
	// Temp[Individual and Entity], permanent[Entity] with TM
	@DataProvider
	...
	// Temp[Individual and Entity], permanent[Entity] with documents
	@DataProvider
	...
	// Temp[Individual and Entity], permanent[Entity] with TM and documents
	@DataProvider
	...
	// Temp[Individual and Entity], permanent[IndividualEntity]
	@DataProvider
	...
	// Temp[Individual and Entity], permanent[Individual and Entity] with TM
	@DataProvider
	...
	// Temp[Individual and Entity], permanent[IndividualEntity] with Documents
	@DataProvider
	...
	// Temp[Individual and Entity], permanent[IndividualEntity] with TM Documents
	@DataProvider
	...
	// Mandatory Fields , Groups , Clients[Individuals] and Temp Clients
	// [Individuals] with TM and Documents
	@DataProvider
	...
	// Mandatory Fields , Groups , Clients[Entity] and Temp Clients
	// [Individual]
	@DataProvider
	...
	// Mandatory Fields , Groups , Clients[Entity] and Temp Clients
	// [Individual] with TM and Documents
	@DataProvider
	public Object[][] getData32() throws IOException {
		...
		// Mandatory, Clients[Individual and Entity], temp clients
	}
	...
	// Mandatory, Clients[Individual and Entity], temp clients and TM
	...
	// Mandatory, Clients[Individual and Entity], temp clients and documents
	...
	// Mandatory Fields , Groups, Temp Clients [Individuals]
	@DataProvider
	...
	// Mandatory Fields , Groups, Temp Clients [Individuals] with TM
	@DataProvider
	...
	// Mandatory Fields , Groups, Temp Clients [Individuals] with TM and Documents
	@DataProvider
	...
	// Mandatory Fields , Groups and Temp Clients [Entity] with Documents
	@DataProvider
	...
	// Mandatory Fields , Groups and Temp Clients [Individual and Entity]
		@DataProvider
		...
		// Mandatory Fields , Groups and Temp Clients [Individual and Entity] with TM
				@DataProvider
				...
				// Mandatory Fields , Groups and Temp Clients [Individual and Entity] with Documents
				@DataProvider
