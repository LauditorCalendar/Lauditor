...
public class ViewMembers extends Reusable {
	...
	public void resetPasswordNoBtn() throws InterruptedException {
		Thread.sleep(7000);
		resetPasswordBtn.click();
		Thread.sleep(7000);
		alertpopupResetPasswordNo.click();
	}
	
	public void resetPasswordCloseBtn() throws InterruptedException {
		Thread.sleep(7000);
		resetPasswordBtn.click();
		Thread.sleep(7000);
		alertpopupResetPasswordClosebtn.click();
	}
	...
	public void deleteMemberNoclick() throws InterruptedException {
		Thread.sleep(7000);
		deleteButton.click();
		Thread.sleep(7000);
		alertpopupDeleteNo.click();
	}
	
	public void deleteMemberCloseBtnclick() throws InterruptedException {
		Thread.sleep(7000);
		deleteButton.click();
		Thread.sleep(7000);
		alertpopupDeleteClosebtn.click();
	}
	...
	@FindBy(xpath="//input[@placeholder='Search Member']")
	WebElement searchBarViewMembersPage;
	
	@FindBy(xpath="//table //tbody")
	WebElement totalBodyOfTeamMember;
	
	public void CheckDeletedMemberVerification(String DeletedMemberName) throws InterruptedException {
		Thread.sleep(2000);
		searchBarViewMembersPage.clear();
		searchBarViewMembersPage.sendKeys(DeletedMemberName);
		boolean text =! totalBodyOfTeamMember.isDisplayed();
