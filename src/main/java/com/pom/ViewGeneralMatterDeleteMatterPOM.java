...
public class ViewGeneralMatterDeleteMatterPOM extends Reusable {
	WebDriver driver;

	public ViewGeneralMatterDeleteMatterPOM(WebDriver driver) {
		super(driver);
		this.driver = driver;
		...
		@FindBy(xpath="//tr[@class='rone veiw-items'] //td[1]")
		WebElement matterNamesPresent;
		
		public void deleteGeneralMatter() throws InterruptedException {
			Thread.sleep(3000);
